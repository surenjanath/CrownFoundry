...
object EngineStore {
    ...
    /**
     * Read whatever is on disk. Safe to call more than once; the second call is a no-op.
     *
     * Never throws. An engine that will not load is a state to draw, not a reason to fail to
     * start the app - the player can still play online, which is what they could do before any
     * of this existed.
     */
    ...
    suspend fun initialise(root: File, preferences: EnginePreferences) = mutex.withLock {
